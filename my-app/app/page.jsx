  ...
  return (
    <div className="bg-background">
      <section className="relative overflow-hidden py-32">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button asChild
                  size='lg'
                  variant='outline'
                  className='bg-emerald-700/30 hover:bg-muted/80 text-white'>
                  <Link href={'/doctors'}>
            ...
            <div className="relative h-[430px] md:h-[580px] lg:h-[500px] rounded-xl overflow-hidden ">
              <Image
                src='/banner2.png'
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge className='bg-emerald-700/30 px-4 py-1 text-emerald-400 text-sm font-medium mb-4'>Affordable Healthcare</Badge>
              ...
              return (
                ...
                >
                  <CardContent className='pt-6'>
                    ...
                    <p className="text-muted-foreground"> &quot; {testimonial.quote}&quot;
                    </p>
                  </CardContent>
                </Card>
              )
